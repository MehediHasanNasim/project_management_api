    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_to', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tasks', to='api.user')),
            ],
        ),
        migrations.CreateModel(
            name='ProjectMember',
        ...
        migrations.AddField(
            model_name='project',
            name='owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='owned_projects', to='api.user'),
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
